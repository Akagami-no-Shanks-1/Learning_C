    ...
    while (1)
    {
        ...
        case 4:
            ...
            case 1:
                ...
                printf("Surface Area of Sphere = %.2f", 4.0 * 3.14 * pow(radius, 2));     // This calculates surface area of sphere 4*pi*r^2
                break;
            case 2:
                ...
                printf("Surface Area of Cylinder = %.2f", 2.0 * 3.14 * radius * (radius + height)); // This calculates surface area of cylinder 2*pi*r*(r+h)
                break;
            case 3:
                ...
                printf("Surface Area of Cone = %.2f", 3.14 * radius * (radius + sqrt(pow(height, 2) + pow(radius, 2)))); // This calculates surface area of cone pi*r*(r+l) where l is slant height
                break;
            case 4:
                ...
                printf("Surface Area of Cuboid = %d", 2 * (length * width + width * height + length * height)); // This calculates surface area of cuboid 2*(lw + wh + lh)
                break;
            case 5:
                ...
                printf("Surface Area of Cube = %d", 6 * pow(length, 2)); // This calculates surface area of cube 6*side^2
                break;
            default:
